...
class WerewolfBehavior:
    ...
    def initialize(self, base_info, diff_data, game_setting):
        ...
        # initialize emotion
        self.emo = emotion.EmotionWerewolf(self.alive)
        ...
        if stattype == "talk":
            ...
            if who == self.base_info["agentIdx"]:
                ...
                if to == self.base_info["agentIdx"]:
                    ...
                    if (
                        content[0] == ActionType.ASK_WHY_DOUBT.value
    ...
    def talk(self):
        ...
        if self.day == 2:
            if self.seers & set(self.alive_without_me) == 0:
                ...
                if self.talk_turn == 1:
                    return self.gen.generate(
                        "divine_WEREWOLF", list(self.seers & set(self.alive_without_me))
                    )
                if self.talk_turn <= 4:
                    return self.gen.generate(
                        "declare_VOTE", list(self.seers & set(self.alive_without_me))
                    )
        return "Over"
    ...
    def attack(self):
        COs = self.seers & set(self.alive_without_me) - {self.attacked_who_lastnight}
        non_COs = (
